...
# 包含：自适应居中裁剪(防挤压变形)、图像加粗、加权L1 Loss、LSGAN(MSE)、TTUR、动态曲线
# ============================================================
...
# [核心修改 1]：添加自适应居中正方形裁剪函数
def center_square_crop(img_pil):
    """
    将长方形图片以中心为基准裁剪为最大可能的正方形，防止后续 resize 破坏宽高比
    """
