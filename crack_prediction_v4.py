# ============================================================
# 多孔发泡材料裂纹预测 - 端到端深度学习优化版
# 包含：性能终极加速(适配3090+76核)、自适应居中裁剪、图像加粗、加权L1 Loss、LSGAN(MSE)、TTUR、动态曲线
# ============================================================
...
import cv2  
# [核心修改 - 性能加速 1]：强制关闭 OpenCV 内部多线程与 OpenCL 加速，防止打满你的 76 核 CPU
cv2.setNumThreads(0)      
...
if __name__ == '__main__':
    ...
    # [核心修改 - 性能加速 2]：配合 RTX 3090 (24G) 和 256GB 内存
    BATCH_SIZE = 32  # 填饱 GPU 显存
    NUM_WORKERS = 12 # 开启 12 个子进程读取数据，榨干 CPU I/O 能力
    ...
    # 断点续训配置
    # ======================================================
    RESUME_TRAINING = False # 建议将其保持False重新从头跑一次
