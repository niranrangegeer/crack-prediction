...
# 包含：性能加速、自适应居中裁剪、图像加粗、加权L1 Loss、
#       LSGAN、TTUR、动态曲线、[新增] 消除Epoch间卡顿
# ============================================================
...
# [核心修改 - 性能加速 1]：强制关闭 OpenCV 内部多线程与 OpenCL 加速
cv2.setNumThreads(0)      
...
if __name__ == '__main__':
    ...
    # [核心修改 6]：增加 persistent_workers=True，彻底消除 Epoch 之间的 30 秒卡顿等待！
